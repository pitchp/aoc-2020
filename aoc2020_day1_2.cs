...
namespace CSharp_Shell
{
    ...
    public static class Program 
    {
        ...
        public static void Main() 
        {
			...
			int[] input_arr2 = Array.ConvertAll(input.Split(" ,"), int.Parse);
			int[] input_arr3 = Array.ConvertAll(input.Split(" ,"), int.Parse);
           //Console.WriteLine(input);
           //Console.WriteLine(input_arr[0] + input_arr[1]);
        	 for (int i = 0; i < input_arr.Length; i = i+1)
        	 {
        		for (int j = 0; j < input_arr2.Length; j=j+1) 	
        		{
        			for (int k = 0; k < input_arr3.Length; k=k+1)
        			
        				if (input_arr[i] + input_arr2[j] + input_arr3[k] == 2020)
        				{
        					
        					Console.WriteLine(input_arr[i]*input_arr2[j]*input_arr3[k]);
        					return;
        				}
